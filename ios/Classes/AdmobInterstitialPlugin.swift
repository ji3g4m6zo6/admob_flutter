...
public class AdmobIntersitialPlugin: NSObject, FlutterPlugin {
    ...
    fileprivate var allIds: [Int: GADInterstitialAd] = [:]
    fileprivate var delegates: [Int: GADFullScreenContentDelegate] = [:]
...
//    private func getInterstitialAd(id: Int, interstantialAdUnitId: String) -> GADInterstitialAd {
...
//    }
    ...
    func ad(_ ad: GADFullScreenPresentingAd, didFailToPresentFullScreenContentWithError error: Error) {
        channel.invokeMethod("failedToLoad", arguments: ["errorCode": (error as NSError).code])
    }
}
